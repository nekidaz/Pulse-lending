$(document).ready(function(){
    ...
    $('.carousel__inner').slick({
        prevArrow: '<button type="button" class="slick-prev"><img src="icon/arrow-left.png"></button>',
        nextArrow: '<button type="button" class="slick-next"><img src="icon/arrow-rigth.png"></button>',
    });
    //tabs settings
